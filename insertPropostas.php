...
if (isset($_POST['subtitulo'])) {
    ...
    try {
        ...
        if ($upload || $imagem !== null) {
            ...
            $result = $db->dbInsert("INSERT INTO propostas
            (icone_bootstrap, subtitulo, texto, texto_card, posicao, imagem, status_registro)
            VALUES (?, ?, ?, ?, ?, ?, ?)", [
...
header("Location: index.php?pagina=listaPropostas");
exit;
?>
